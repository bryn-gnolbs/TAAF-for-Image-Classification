...
# Define a simple CNN model for CIFAR-100 with ELU (or TAAF/Combined)
class CIFAR100Model(nn.Module):
    def __init__(self, activation_type="ELU", elu_alpha=1.0, elu_beta=1.0):
        ...
        self.fc1 = nn.Linear(
            64 * 8 * 8, 128
        )  # Input size adjusted for CIFAR-100 (8x8 feature map)
...
num_epochs = 300  # Increased epochs for CIFAR-100
model_name_suffix = activation_type
model_dir = "./tests/cifar100/"
...
model_filename = f"{model_dir}cifar100_{model_name_suffix}_model_300epochs_AdamW.pth"  # Updated filename
